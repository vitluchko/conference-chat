...
<body class="min-h-screen bg-gray-50">
    ...
    <header class="flex items-center justify-between p-6">
        ...
        <div class="flex gap-2">
            <a href="" class="rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Profile</a>
